...
> Catalogue of things is ruby project used record books, Music Album and games in the library. The library user is have multiple selection of choosing which activity to perfom at the library.
Depending on wether he want either music, book, or game... he gets different selection on listing all the available items in the store, and few choices are given to add his favorite to the store. 
